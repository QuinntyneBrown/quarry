...
import { QuizAnswerMap } from './quiz-answer-map.type';
import { QuizQuestionView } from '../quiz-question/quiz-question-view.interface';

export interface QuizView extends CsViewModel {
