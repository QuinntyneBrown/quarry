...
import { PanelState } from './panel-state.type';
import { ReportView } from './report-view.interface';

export interface ReportViewModel extends CsViewModel {
  readonly title: string;
  readonly panels: readonly ReportView[];
