...
import { QuizOutcome } from './quiz-outcome.type';
import { QuizQuestionResult } from './quiz-question-result.interface';

export interface QuizResultView extends CsViewModel {
